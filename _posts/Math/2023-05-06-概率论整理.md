...
|待估参数|其它参数|统计量|置信区间|
|:---:|:---:|:---:|:---:|
|$\mu$|$\sigma^2$已知|$T = \frac{\bar{X} - \mu}{\sigma/\sqrt{n}} \sim N(0,1)$|$(\bar{X} - \frac{\sigma}{\sqrt{n}}z_{\alpha/2},\bar{X} + \frac{\sigma}{\sqrt{n}}z_{\alpha/2})$|
|$\mu$|$\sigma^2$未知|$T = \frac{\bar{X} - \mu}{S/\sqrt{n}} \sim t(n-1)$|$(\bar{X} - \frac{S}{\sqrt{n}}t_{\alpha/2}(n-1),\bar{X} + \frac{S}{\sqrt{n}}t_{\alpha/2}(n-1))$|
|$\sigma^2$|$\mu$未知|$T = \frac{(n-1)S^2}{\sigma^2} \sim \chi^2(n-1)$|$(\frac{(n-1)S^2}{\chi^2_{\alpha/2}(n-1)},\frac{(n-1)S^2}{\chi^2_{1-\alpha/2}(n-1)})$|